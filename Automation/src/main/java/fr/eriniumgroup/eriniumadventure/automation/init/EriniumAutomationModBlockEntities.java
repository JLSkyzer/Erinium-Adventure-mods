...
public class EriniumAutomationModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>> NETHER_STAR_GENERATOR = register("nether_star_generator", EriniumAutomationModBlocks.NETHER_STAR_GENERATOR, NetherStarGeneratorBlockEntity::new);
