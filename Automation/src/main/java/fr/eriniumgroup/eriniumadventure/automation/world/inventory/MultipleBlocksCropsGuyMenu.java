...
public class MultipleBlocksCropsGuyMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MultipleBlocksCropsGuyMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
