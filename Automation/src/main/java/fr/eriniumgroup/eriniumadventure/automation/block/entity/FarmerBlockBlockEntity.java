...
public class FarmerBlockBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("farmer_block");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new FarmerGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(250000, 1000, 0, 0) {
		@Override
