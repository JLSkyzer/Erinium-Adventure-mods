...
import fr.eriniumgroup.eriniumadventure.automation.procedures.AstralGetPercentProcedure;
import fr.eriniumgroup.eriniumadventure.automation.procedures.AstralGetEnergyProcedure;
...
public class AstralMinerGuiScreen extends AbstractContainerScreen<AstralMinerGuiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("erinium_automation:textures/screens/astral_miner_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				AstralGetEnergyProcedure.execute(world, x, y, z), 2, 16, -12829636, false);
		guiGraphics.drawString(this.font,
