...
import fr.eriniumgroup.eriniumadventure.automation.network.EriniumAutomationModVariables;
...
@Mod("erinium_automation")
public class EriniumAutomationMod {
	public static final Logger LOGGER = LogManager.getLogger(EriniumAutomationMod.class);
	public static final String MODID = "erinium_automation";

	public EriniumAutomationMod(IEventBus modEventBus) {
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		EriniumAutomationModBlocks.REGISTRY.register(modEventBus);
		EriniumAutomationModBlockEntities.REGISTRY.register(modEventBus);
		EriniumAutomationModItems.register(modEventBus);

		EriniumAutomationModTabs.REGISTRY.register(modEventBus);
		EriniumAutomationModVariables.ATTACHMENT_TYPES.register(modEventBus);

		EriniumAutomationModMenus.REGISTRY.register(modEventBus);
