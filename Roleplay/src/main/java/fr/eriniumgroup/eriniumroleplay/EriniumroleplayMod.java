...
@Mod("eriniumroleplay")
public class EriniumroleplayMod {
	public static final Logger LOGGER = LogManager.getLogger(EriniumroleplayMod.class);
	public static final String MODID = "eriniumroleplay";

	public EriniumroleplayMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		EriniumroleplayModVariables.ATTACHMENT_TYPES.register(modEventBus);
