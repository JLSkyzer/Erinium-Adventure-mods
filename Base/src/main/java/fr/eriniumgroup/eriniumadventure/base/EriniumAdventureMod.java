...
public class EriniumAdventureMod {
	...
	public EriniumAdventureMod(IEventBus modEventBus) {
		...
		EriniumAdventureModBlocks.REGISTRY.register(modEventBus);

		EriniumAdventureModItems.register(modEventBus);
		EriniumAdventureModEntities.REGISTRY.register(modEventBus);
		EriniumAdventureModTabs.REGISTRY.register(modEventBus);
		EriniumAdventureModVariables.ATTACHMENT_TYPES.register(modEventBus);

		EriniumAdventureModParticleTypes.REGISTRY.register(modEventBus);
