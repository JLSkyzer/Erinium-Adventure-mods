...
public abstract class NitriateArmorItem extends ArmorItem {
	public NitriateArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends NitriateArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends NitriateArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends NitriateArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "erinium_adventure:textures/models/armor/nitriate_layer_2.png";
		}
	}

	public static class Boots extends NitriateArmorItem {
		public Boots() {
