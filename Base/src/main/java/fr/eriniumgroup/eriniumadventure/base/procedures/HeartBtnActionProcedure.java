...
public class HeartBtnActionProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (ModList.get().isLoaded("ericonomy")) {
			...
			try {
				...
				if (eriJsonObject.get("money").getAsDouble() >= ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(1)).getItem() : ItemStack.EMPTY)
