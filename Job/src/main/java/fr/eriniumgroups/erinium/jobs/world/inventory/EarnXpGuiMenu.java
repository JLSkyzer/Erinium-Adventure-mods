...
import fr.eriniumgroups.erinium.jobs.procedures.EarnXpTickProcedure;
import fr.eriniumgroups.erinium.jobs.init.EriniumjobsModMenus;

@Mod.EventBusSubscriber
public class EarnXpGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EarnXpGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EriniumjobsModMenus.EARN_XP_GUI.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof EarnXpGuiMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			EarnXpTickProcedure.execute(world, entity);
		}
	}
}
