...
public class EriniumjobsMod {
	...
	public static final String MODID = "eriniumjobs";

	public EriniumjobsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		EriniumjobsModItems.register(modEventBus);

		EriniumjobsModVariables.ATTACHMENT_TYPES.register(modEventBus);

		EriniumjobsModMenus.REGISTRY.register(modEventBus);
