...
import fr.eriniumgroups.erinium.jobs.procedures.UnlockedTickProcedure;
import fr.eriniumgroups.erinium.jobs.init.EriniumjobsModMenus;

@Mod.EventBusSubscriber
public class UnlockedGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public UnlockedGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EriniumjobsModMenus.UNLOCKED_GUI.get(), id);
		...
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 25, 42) {
		...
		this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 61, 42) {
		...
		this.customSlots.put(14, this.addSlot(new SlotItemHandler(internal, 14, 97, 42) {
		...
		this.customSlots.put(16, this.addSlot(new SlotItemHandler(internal, 16, 133, 42) {
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof UnlockedGuiMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			UnlockedTickProcedure.execute(world, entity);
		}
	}
}
