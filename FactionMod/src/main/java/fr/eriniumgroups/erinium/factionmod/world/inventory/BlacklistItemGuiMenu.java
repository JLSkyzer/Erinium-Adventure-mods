...
package fr.eriniumgroups.erinium.factionmod.world.inventory;
...
import fr.eriniumgroups.erinium.factionmod.procedures.BlacklistItemGuiWhileThisGUIIsOpenTickProcedure;
import fr.eriniumgroups.erinium.factionmod.init.EriniumFactionModMenus;

@Mod.EventBusSubscriber
public class BlacklistItemGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BlacklistItemGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EriniumFactionModMenus.BLACKLIST_ITEM_GUI.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof BlacklistItemGuiMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			BlacklistItemGuiWhileThisGUIIsOpenTickProcedure.execute(entity);
		}
	}
}
