							...
							File = ReturnCommandOfflineEntityPathProcedure.execute(arguments);
							{
								try {
									...
									if (entity instanceof Player _player && !_player.level().isClientSide())
										_player.displayClientMessage(Component.literal(("\u00A7aPromoted \u00A7e" + JsonObject.get("player_name").getAsString() + " \u00A7ato rank : \u00A75" + JsonObject.get("faction_rank").getAsString())), false);
								} catch (IOException e) {
									e.printStackTrace();
								}
							}
