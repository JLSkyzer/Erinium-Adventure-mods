...
public class FactionClaimsPathProcedure {
	public static File execute(LevelAccessor world, Entity entity) {
		...
		if (TargetEntityHaveFactionProcedure.execute(entity)) {
			return new File((FMLPaths.GAMEDIR.get().toString() + "/Faction_list/" + entity.getData(EriniumFactionModVariables.PLAYER_VARIABLES).faction_name + "/claim_list/" + new Object() {
