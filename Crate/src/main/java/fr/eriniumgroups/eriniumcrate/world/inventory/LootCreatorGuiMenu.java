...
public class LootCreatorGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LootCreatorGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EriniumcrateModMenus.LOOT_CREATOR_GUI.get(), id);
