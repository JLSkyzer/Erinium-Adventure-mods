package fr.eriniumgroups.erinium.ericonomy;
...
import fr.eriniumgroups.erinium.ericonomy.network.EriconomyModVariables;
...
public class EriconomyMod {
	...
	public static final String MODID = "ericonomy";

	public EriconomyMod(IEventBus modEventBus) {
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		EriconomyModBlocks.REGISTRY.register(modEventBus);
		EriconomyModBlockEntities.REGISTRY.register(modEventBus);
		EriconomyModItems.register(modEventBus);

		EriconomyModTabs.REGISTRY.register(modEventBus);
		EriconomyModVariables.ATTACHMENT_TYPES.register(modEventBus);

		EriconomyModMenus.REGISTRY.register(modEventBus);
