...
public class MoneyGiveProcedure {
				...
				try {
					...
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(
								Component.literal(("\u00A7eEriconomy \u00A7f>> " + "\u00A7a+ " + new java.text.DecimalFormat("#,###.##").format(DoubleArgumentType.getDouble(arguments, "amount")) + "$ \u00A7b--> " + (new Object() {
					...
					if ((new Object() {
						...
						_player.displayClientMessage(Component.literal(("\u00A7eEriconomy \u00A7f>> " + "\u00A7a+ " + new java.text.DecimalFormat("#,###.##").format(DoubleArgumentType.getDouble(arguments, "amount")) + "$")), false);
					if (ModList.get().isLoaded("erinium_logs")) {
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(0, 0, 0), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
									"erilog " + "Ericonomy" + " " + "info" + " "
											+ ("ADMIN " + entity.getDisplayName().getString() + " send " + new java.text.DecimalFormat("#,###.##").format(DoubleArgumentType.getDouble(arguments, "amount")) + " to " + (new Object() {
												public Entity getEntity() {
													try {
														return EntityArgument.getEntity(arguments, "player");
													} catch (CommandSyntaxException e) {
