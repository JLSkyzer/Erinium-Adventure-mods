package fr.eriniumgroups.erinium.auctionhouse;
...
public class EriniumAhMod {
	...
	public static final String MODID = "erinium_ah";

	public EriniumAhMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		EriniumAhModVariables.ATTACHMENT_TYPES.register(modEventBus);

		EriniumAhModMenus.REGISTRY.register(modEventBus);
