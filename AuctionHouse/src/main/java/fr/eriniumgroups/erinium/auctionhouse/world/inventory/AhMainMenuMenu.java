...
import fr.eriniumgroups.erinium.auctionhouse.procedures.AhMainMenuWhileThisGUIIsOpenTickProcedure;
import fr.eriniumgroups.erinium.auctionhouse.init.EriniumAhModMenus;

@Mod.EventBusSubscriber
public class AhMainMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AhMainMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EriniumAhModMenus.AH_MAIN_MENU.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof AhMainMenuMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			AhMainMenuWhileThisGUIIsOpenTickProcedure.execute(world, entity, guistate);
		}
	}
}
