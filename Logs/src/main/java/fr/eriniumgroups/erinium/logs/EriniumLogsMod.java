package fr.eriniumgroups.erinium.logs;
...
@Mod("erinium_logs")
public class EriniumLogsMod {
	public static final Logger LOGGER = LogManager.getLogger(EriniumLogsMod.class);
	public static final String MODID = "erinium_logs";

	public EriniumLogsMod(IEventBus modEventBus) {
